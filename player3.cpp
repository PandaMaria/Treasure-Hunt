...
player3::player3(int x,int y,map &harta)
{
    xposition=x;
    yposition=y;
    status=1;
    ...
    if(harta.matrice[xposition+1][yposition]=='*')
        {
            ...
            harta.matrice[xposition][yposition]='#';
            cout<<"jucatorul 3 s-a mutat pe pozitia "<<xposition+1<<" "<<yposition<<" si a gasit comoara."<<endl;
            return;
        }
    if(harta.matrice[xposition-1][yposition]=='*')
        {
    ...
    if(harta.matrice[xposition][yposition-1]=='*')
        {
            ...
            harta.matrice[xposition][yposition]='#';
            cout<<"jucatorul 3 s-a mutat pe pozitia "<<xposition<<" "<<yposition-1<<" si a gasit comoara."<<endl;
            return;
        }
    if(harta.matrice[xposition][yposition+1]=='*')
        {
